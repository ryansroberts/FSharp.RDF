...
type ProvidedConstructor = 
  ...
  member InvokeCode : (Quotations.Expr list -> Quotations.Expr)
  /// FSharp.Data addition: this method is used by Debug.fs
  member internalGetInvokeCodeInternal : bool
     -> (Quotations.Expr [] -> Quotations.Expr)
  /// Set the target and arguments of the base constructor call. Only used for generated types.
  member BaseConstructorCall : (Quotations.Expr list -> (ConstructorInfo * Quotations.Expr list))
...
type ProvidedMethod = 
  ...
  new : methodName:string * parameters:ProvidedParameter list * returnType:Type
     -> ProvidedMethod
...
type ProvidedProperty = 
  ...
  new : propertyName:string * propertyType:Type * ?parameters:ProvidedParameter list
     -> ProvidedProperty
  ...
  member GetterCode : (Quotations.Expr list -> Quotations.Expr)
  /// Set the function used to compute the implementation of sets of this property.
  member SetterCode : (Quotations.Expr list -> Quotations.Expr)
  /// Add definition location information to the provided type definition.
  member AddDefinitionLocation : line:int * column:int * filePath:string -> unit
...
type ProvidedEvent = 
  ...
  member IsStatic : bool
  /// Set the quotation used to compute the implementation of gets of this property.
  member AdderCode : (Quotations.Expr list -> Quotations.Expr)
  /// Set the function used to compute the implementation of sets of this property.
  member RemoverCode : (Quotations.Expr list -> Quotations.Expr)
  /// Add definition location information to the provided type definition.
  member AddDefinitionLocation : line:int * column:int * filePath:string -> unit
...
type ProvidedTypeBuilder = 
  ...
  static member MakeGenericType : genericTypeDefinition:System.Type * genericArguments:System.Type list
     -> System.Type
  /// Like methodInfo.MakeGenericMethod, but will also work with unit-annotated types and provided types
  static member MakeGenericMethod : genericMethodDefinition:System.Reflection.MethodInfo * genericArguments:System.Type list
     -> MethodInfo
...
type ProvidedMeasureBuilder = 
  ...
  member AnnotateType : basic:System.Type * argument:System.Type list
     -> System.Type
...
type ProvidedTypeDefinition = 
  ...
  new : assembly:Assembly * namespaceName:string * className:string * baseType:Type option
  ...
  member AddInterfaceImplementationsDelayed : interfacesFunction:(unit -> Type list)
     -> unit
  /// Specifies that the given method body implements the given method declaration.
  member DefineMethodOverride : methodInfoBody:ProvidedMethod * methodInfoDeclaration:MethodInfo
     -> unit
  ...
  member AddAssemblyTypesAsNestedTypesDelayed : assemblyFunction:(unit -> System.Reflection.Assembly)
     -> unit
  // Parametric types
  member DefineStaticParameters : parameters:ProvidedStaticParameter list * instantiationFunction:(string -> obj [] -> ProvidedTypeDefinition)
     -> unit
  /// Add definition location information to the provided type definition.
  member AddDefinitionLocation : line:int * column:int * filePath:string -> unit
  ...
  /// FSharp.Data addition: this method is used by Debug.fs
  member MakeParametricType : name:string * args:obj []
     -> ProvidedTypeDefinition
...
type ProvidedAssembly = 
  ...
  member AddNestedTypes : types:ProvidedTypeDefinition list * enclosingGeneratedTypeNames:string list
     -> unit
...
type TypeProviderForNamespaces = 
  ...
  new : namespaceName:string * types:ProvidedTypeDefinition list
     -> TypeProviderForNamespaces
  /// Initializes a type provider 
  new : unit -> TypeProviderForNamespaces
  /// Add a namespace of provided types.
  member AddNamespace : namespaceName:string * types:ProvidedTypeDefinition list
     -> unit
  /// FSharp.Data addition: this method is used by Debug.fs
  /// Get all namespace with their provided types.
  member Namespaces : (string * ProvidedTypeDefinition list) seq
